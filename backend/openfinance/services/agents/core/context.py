...
Adapted from nanobot's context system for OpenFinance agents.
"""
...
class ContextBuilder:
    ...
    def __init__(self, workspace: Path, agent_name: str = "OpenFinance Agent"):
...
When remembering something, write to {workspace_path}/memory/MEMORY.md"""
    ...
    def add_assistant_message(
        ...
        Args:
            ...
            reasoning_content: Thinking output (for reasoning models).
