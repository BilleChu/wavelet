"""
Data Quality Checker - Comprehensive data quality assessment.
...
class DataQualityChecker:
    """
    Comprehensive data quality checker with configurable thresholds.
    ...
    def __init__(
        ...
        min_timeliness_hours: int | None = None,
    ) -> None:
        config = get_config()
        
        self._min_completeness = min_completeness or config.quality_thresholds.completeness
        self._min_accuracy = min_accuracy or config.quality_thresholds.accuracy
        self._min_timeliness_hours = min_timeliness_hours or config.quality_thresholds.timeliness_hours
