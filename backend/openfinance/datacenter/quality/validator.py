"""
Data Validator for Data Center.

Provides schema validation and business rule validation
...
class SchemaValidator:
    ...
    Usage:
        ...
        validator = SchemaValidator(StockQuote)
        result = validator.validate({"code": "600000", "name": "浦发银行", "close": 10.5})
    """
